    ...
    bg-feature-bg bg-center bg-no-repeat py-24'>
      ...
      flex justify-end'>
          ...
          <div className='z-20 flex w-full flex-col lg:w-[60%]'>
              ...
              <ul className='mt-10 grid gap-10 md:grid-cols-2lg:mg-20 lg:gap-20'>
...
const FeatureItem = ({title,icon, variant, description} : featureProps) => {
  return (
      <li className='flex w-full flex-1 flex-col items-start'>
          ...
          <p className='regular-16 mt-5 bg-white/80 text-gray-30 lg:mt-[3opx] lg:bg-none'>{description}</p>
     </li>
  )
}
